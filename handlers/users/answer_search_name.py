...
@dp.message_handler(state=Questions.search_name,
                    user_id=USERS)  # хэндлер, с первым состоянием, который принимает ответ
async def answer_search_name(message: types.Message, state=FSMContext):
    ...
    urllib.request.urlretrieve('https://aparat.ua/cli/telegram_opt.xlsx', 'out.xlsx')
    path_to_file_1 = os.path.abspath('out.xlsx')

    urllib.request.urlretrieve('https://aparat.ua/xlsx/stock_balance.xlsx', 'stock_balance.xlsx ')
    path_to_file_2 = os.path.abspath('stock_balance.xlsx ')

    urllib.request.urlretrieve('https://aparat.ua/xlsx/boriychuk.xlsx', 'boriychuk.xlsx')
    path_to_file_3 = os.path.abspath('boriychuk.xlsx')

    urllib.request.urlretrieve('https://aparat.ua/xlsx/other.xlsx', 'other.xlsx')
        ...
        for path in path_to_file:
            ...
            if len(graph) > 0:
                ...
                if graph['path'] == path_to_file_1:
                    ...
                    fin_mess_graph['main_quantity'] = f'\nОсновной склад кол-во: {main_quantity}'
                    ...
                    fin_mess_graph['sh_quantity'] = f'\nСклад "На магазине" кол-во: {sh_quantity}'
                    ...
                    fin_mess_graph['b_quantity'] = f'\nСклад "Партнер эхолоты" кол-во: {b_quantity}'
                    ...
                    fin_mess_graph['o_quantity'] = f'\nСклад "Другие партнеры" кол-во: {o_quantity}'
